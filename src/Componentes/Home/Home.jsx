  ...
  return (
    <div id="div_all">
      ...
      <div id="div_body">
        ...
        <h1 id="texto_titulo"> Meu Doce Cardápio: <br />Sua doceria na internet,<br /> do  jeitinho que você<br /> precisa!</h1>
        <p id="texto_home"> Você ama preparar doces, bolos e delícias caseiras, mas sente<br /> dificuldade na hora de usar a internet para montar seu cardápio<br /> online? A gente entende, e criou a solução perfeita para você.</p>
